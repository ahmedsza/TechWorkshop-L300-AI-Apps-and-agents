...
# print scenario and tracer
logger.info(f"Starting chat_app.py - Scenario: {scenario}")
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    async def run_customer_loyalty_task(customer_id):
        ...
        with tracer.start_as_current_span("Run Customer Loyalty Thread"):
            # print a message in console in red
            print(f"\033[91mRunning Customer Loyalty Thread for customer_id: {customer_id}\033[0m")
            logger.info("Running Customer Loyalty Thread", extra={"customer_id": customer_id})  
